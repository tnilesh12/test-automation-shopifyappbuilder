...
import '/views/widgets/product_grid_view.dart';
...
Widget GetViewForRender(BuildContext context, ProductListScreenState state,
            ...
            child: BlocBuilder<ProductListScreenBloc, ProductListScreenState>(
              ...
              return NotificationListener<ScrollEndNotification>(
                  ...
                  child: Column(
                    children: [
                      Expanded(
                          child: GetViewForRender(context, state,
