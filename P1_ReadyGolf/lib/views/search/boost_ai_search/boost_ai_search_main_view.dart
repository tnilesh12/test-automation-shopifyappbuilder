...
import '/views/search/boost_ai_search/product_grid_view_boostAI.dart';
import '/views/search/suggested_search_view.dart';
import '/views/shimmer/search_shimmer_view.dart';
import 'package:go_router/go_router.dart';
import '/views/widgets/no_data_view.dart';
import 'package:shopify_code/globels.dart' as globals;
import '/views/search/search_history_view.dart';
