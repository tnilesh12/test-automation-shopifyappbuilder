...
class _ProductDetailsScreenState extends State<ProductDetailsScreen> {
  ...
  AddItemInCart(BuildContext context, String selectedVal, bool isByNow) async {
    String variantId =
        await context.read<ProductDetailsScreenBloc>().selectedVariant.id!;
    String? sellingPlanId =
        sellingPlan != null ? sellingPlan!.id.toString() : null;
    if (isByNow) {
      sellingPlanId != null
          ? context
              .read<AddToCartBloc>()
              .add(OnBuyNowButtonClick(variantId, sellingPlanId: sellingPlanId))
          : context
              .read<AddToCartBloc>()
      ...
      sellingPlanId != null
          ? context.read<AddToCartBloc>().add(
              OnAddToCartButtonClick(variantId, sellingPlanId: sellingPlanId))
          : context
              .read<AddToCartBloc>()
        ...
        ? showModalBottomSheet(
            ...
            builder: (context) => EasySubscriptionView(
                  ...
                  selectedOption == 1
                      ...
                      : AddItemInCart(context1, sellingPlan!.id!, isByNow);
                }))
        : AddItemInCart(context1, "", isByNow);
  }
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      padding: EdgeInsets.only(
                                          ...
                                          right: ThemeSize.paddingRight,
                                          top: 1),
                                      child: PluginStarWidgetMain(state
                                          .product.id!
                                          .replaceAll(
                                              "gid://shopify/Product/", "")
                                          .toString(), (url) {
