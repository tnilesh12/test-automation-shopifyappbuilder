...
import '/views/dashboard_screen/email_subscription/email_subscription_bottom_sheet.dart';
...
import '/views/dashboard_screen/bloc/dashboard_screen_bloc.dart';
...
import '/views/search/boost_ai_search/boost_ai_search_screen.dart';
...
import '/views/widgets/drawer/drawer1.dart';
import 'package:flutter_svg/flutter_svg.dart';
import 'package:go_router/go_router.dart';
import '../common_bloc/cart_count/cart_bloc.dart';
import '../common_bloc/cart_count/cart_state.dart';
...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  Future<void> updateSelectedBtmNav(BottomNavigationData bottomNavData) async {
