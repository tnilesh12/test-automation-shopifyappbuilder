...
class LooxRatingWebViewWidgetTwo extends StatefulWidget {
  String productId;

  LooxRatingWebViewWidgetTwo(this.productId) {}

  @override
  State<LooxRatingWebViewWidgetTwo> createState() => _LooxRatingWebViewWidgetTwoState();
}

class _LooxRatingWebViewWidgetTwoState extends State<LooxRatingWebViewWidgetTwo> {
