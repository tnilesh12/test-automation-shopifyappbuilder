...
class LooxRatingWebViewStarWidget extends StatefulWidget {
  String productId;

  LooxRatingWebViewStarWidget(this.productId) {}

  @override
  State<LooxRatingWebViewStarWidget> createState() => _LooxRatingWebViewStarWidgetState();
}

class _LooxRatingWebViewStarWidgetState extends State<LooxRatingWebViewStarWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    // print("------------urlllllllllllll----${ApiConst.looxReviewFirst}------");
    return Container(
  ...
  _loadContent(String productId) {
    try {
       print("----------${Uri.parse(ApiConst.looxReviewFirst.replaceAll("{product_id}", productId))}------------");
