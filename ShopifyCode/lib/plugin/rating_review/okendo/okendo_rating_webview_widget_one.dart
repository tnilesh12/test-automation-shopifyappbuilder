...
class OkendoRatingWebViewWidgetOne extends StatefulWidget {
  String productId;

  OkendoRatingWebViewWidgetOne(this.productId) {}

  @override
  State<OkendoRatingWebViewWidgetOne> createState() =>
      _OkendoRatingWebViewWidgetOneState();
}

class _OkendoRatingWebViewWidgetOneState
    extends State<OkendoRatingWebViewWidgetOne> {
