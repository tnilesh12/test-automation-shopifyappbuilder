...
import 'package:shopify_code/plugin/rebuy_product/top_seller/Bloc/top_seller_product_bloc.dart';
...
class RebuyTopSellerProductView extends StatelessWidget {
  Function(dynamic) OnClick;
  RebuyTopSellersData rebuyTopSellersData;

  RebuyTopSellerProductView(this.rebuyTopSellersData, this.OnClick);
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (context) => TopSellerProductBloc(),
      child: BlocListener<TopSellerProductBloc, TopSellerProductState>(
        listener: (context, state) {},
        child: BlocBuilder<TopSellerProductBloc, TopSellerProductState>(
            builder: (context, state) {
          if (state is TopSellerProductSuccessState) {
