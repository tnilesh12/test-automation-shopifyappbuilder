...
import 'package:shopify_code/plugin/rebuy_product/recommended_product/bloc/recommended_view_bloc.dart';
...
class RebuyRecommendedProductView extends StatelessWidget {
  Function(dynamic) OnClick;
  RebuyRecommendedProductData rebuyRecommendedProductData;

  RebuyRecommendedProductView(this.rebuyRecommendedProductData, this.OnClick);
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (context) => RecommendedViewBloc(),
      child: BlocListener<RecommendedViewBloc, RecommendedViewState>(
        listener: (context, state) {},
        child: BlocBuilder<RecommendedViewBloc, RecommendedViewState>(
            builder: (context, state) {
          if (state is RecommendedViewSuccessState) {
