...
import 'package:shopify_code/plugin/rebuy_product/quick_view/Bloc/quick_view_bloc.dart';
...
class RebuyQuickView extends StatelessWidget {
  Function(dynamic) OnClick;
  RebuyQuickViewData rebuyQuickViewData;

  RebuyQuickView(this.rebuyQuickViewData, this.OnClick);
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (context) => QuickViewBloc(),
      child: BlocListener<QuickViewBloc, QuickViewState>(
        listener: (context, state) {},
        child: BlocBuilder<QuickViewBloc, QuickViewState>(
            builder: (context, state) {
          if (state is QuickViewSuccessState) {
