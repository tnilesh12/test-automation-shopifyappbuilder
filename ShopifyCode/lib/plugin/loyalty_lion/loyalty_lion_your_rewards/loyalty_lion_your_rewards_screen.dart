...
import 'package:shopify_code/plugin/loyalty_lion/loyalty_lion_your_rewards/bloc/loyalty_lion_your_rewards_bloc.dart';
...
class LoyaltyLionYourRewardsScreen extends StatelessWidget {
  String customerMerchantId;
  LoyaltyLionYourRewardsScreen(this.customerMerchantId, {super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: BlocProvider(
          create: (context) => LoyaltyLionYourRewardsBloc(customerMerchantId),
          child: BlocListener<LoyaltyLionYourRewardsBloc, LoyaltyLionYourRewardsState>(
            listener: (context, state) {
              // TODO: implement listener
            },
            child: BlocBuilder<LoyaltyLionYourRewardsBloc, LoyaltyLionYourRewardsState>(
              builder: (context, state) {
                dynamic yourRewardsData =
                    context.read<LoyaltyLionYourRewardsBloc>().yourRewardsData;

                if (state is LoyaltyLionYourRewardsLoadingState) {
                  return Center(
                    child: Text("Loading"),
