...
class StyleDefaultCountDownTimer extends StatefulWidget {
  CountDownDate countDownDate;
  StyleDefaultCountDownTimer(this.countDownDate, {super.key});

  @override
  State<StyleDefaultCountDownTimer> createState() =>
      _StyleDefaultCountDownTimerState();
}

class _StyleDefaultCountDownTimerState
    extends State<StyleDefaultCountDownTimer> {
  late Timer timer;
  int days = 0;
  int hours = 0;
  int minutes = 0;
            ...
            child: Row(
              ...
              children: [
                ...
                Text(":",
                    style: TextStyle(
                        color: Utils.getColorFromHex(
                            widget.countDownDate.cellColor!),
                        fontSize: 29,
                        fontWeight: FontWeight.bold)),
                ...
                Text(":",
                    style: TextStyle(
                        ...
                        fontSize: 29,
                        fontWeight: FontWeight.bold)),
                difference.inSeconds.toString().contains("-")
                    ? Container(
                        padding:
                            EdgeInsets.symmetric(horizontal: 2, vertical: 5),
                        decoration: BoxDecoration(
