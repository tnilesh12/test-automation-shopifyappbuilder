...
class ThemeSize {
  ...
  static double themeBorderRadius = 0;//DashboardFontSize.customBorderRadius;
  ...
  static double productGridAspectRatio({required String type}) {
    double imageheight 
    // = DashboardFontSize.imagetype == "Adapt To Image"
    //     ? 250
  ...
  static double imageHeightForProductDetailsPage(BuildContext context) {
    return 
    // DashboardFontSize.imagetype == "Adapt To Image"
