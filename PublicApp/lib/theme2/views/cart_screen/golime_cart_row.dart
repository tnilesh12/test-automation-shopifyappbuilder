...
import 'package:shopify_code/modelClass/cart/cart_item.dart' as cartItemModel;
...
class GoLimeCartRow extends StatelessWidget {
  cartItemModel.CartItem cartItem;
  final Function onDelete;
  final Function(int) onUpdateQuantity;

  GoLimeCartRow(this.cartItem, this.onDelete, this.onUpdateQuantity,
      {super.key});
                          ...
                          children: [
                            Padding(
                              ...
                              child: Container(
                                  width: 50,
                                  child: Image.asset(
                                      cartItem.merchandise!.title.toString() ==
                                              'Go Flex'
                            ...
                            Row(
                              ...
                              children: [
                                Text(
                                    cartItem
                                        .merchandise!.priceV2!.formattedPrice
                                        .toString(),
                                    overflow: TextOverflow.ellipsis,
                                    textAlign: TextAlign.center,
                                    style: CustomTextTheme.getTextStyle(
