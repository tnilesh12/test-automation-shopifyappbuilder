...
import 'package:publicapp/theme2/views/product_list/product_list_screen.dart';
              ...
              child: BlocBuilder<CartScreenBloc, CartScreenState>(
                builder: (context, state) {
                  ...
                  return Container(
                        ...
                        : state is CartScreenNoData
                            ...
                            : Expanded(
                                ...
                                itemBuilder: (BuildContext context, int index) {
                                  return (AppConfig.APP_NAME.toUpperCase() ==
                                          "GOLIME")
                                      ? GoLimeCartRow(
                                          context
                                              .read<CartScreenBloc>()
                    ...
                    (AppConfig.APP_NAME.toUpperCase() == "GOLIME")
                        ? Card(
                                ...
                                children: [
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        Text(
                                            "You may also like to Protect your equipment",
                                        ...
                                        Text(
                                            "Go Protect coverage Protects your old or new equipment and ensures home comfort.",
                                            style: CustomTextTheme.getTextStyle(
                                                    MyTextStyle
                                                        .CommonThemeSubTitle,
                                                    context)
                                  ...
                                  IconButton(
                                      ...
                                      onPressed: () {
                                        ProductListScreen productListScreen =
                                            ProductListScreen("317183950998",
                                                "Protection Plan");
                                        context.push(
