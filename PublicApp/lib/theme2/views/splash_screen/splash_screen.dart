...
import 'package:publicapp/common/bloc/splash_screen_bloc/splash_screen_bloc.dart';
import 'package:publicapp/common/bloc/splash_screen_bloc/splash_screen_state.dart';
    ...
    return Scaffold(
      ...
      body: BlocListener<SplashScreenBloc, SplashScreenState>(
        listener: (context, state) {
          if (state is SplashScreenNoInternetState) {
            Dialogs.ErrorAlertInOut(
                context: context,
                message: LanguageManager.translations()['internetConnection']);
          }
          if (state is SplashScreenShopNotValidState) {
          ...
          if (state is SplashScreenLoadedState) {
            FirebaseMessaging.instance
              ...
              if (message != null) {
                ...
                // Timer(Duration(seconds: 3), () {
                if (context.read<SplashScreenBloc>().islogin) {
                  print(
          ...
          builder: (context, state) {
            if (state is SplashScreenLoadingState) {
              return Container(
                  ...
                  child: Center(
                    child: Text(
                      context.read<SplashScreenBloc>().appName!,
