...
class BottomBarWidget extends StatefulWidget {
  ...
  // dynamic list;
  final Function(BottomNavigationData bottomNavigationData, int selectedIndex) onTabChange;

  BottomBarWidget(this.dashboardDataItems, {Key? key, required this.onTabChange})
      : super(key: key);
...
*/
            ...
            children:
              ...
              return Expanded(
                child: Container(
                  margin: EdgeInsets.symmetric(horizontal: 0), //1.5),
                  child: GestureDetector(
                    onTap: () {
                      //  onItemSelected(index)
                      setState(() {
                        selectedIndex = index;
                        widget.onTabChange(widget
                            .dashboardDataItems.bottomNavigationData![index], index);
                      });
    ...
    return Semantics(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          // borderRadius:
          //     BorderRadius.all(Radius.circular(Theme2Size.themeBorderRadius)),
        ),
