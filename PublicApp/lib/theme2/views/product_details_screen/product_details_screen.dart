...
import 'package:publicapp/theme2/views/widgets/common/custom_button.dart';
import 'package:publicapp/theme2/views/product_details_screen/widgets/go_lime_product_specification_widget.dart';
import 'package:publicapp/theme2/views/product_details_screen/widgets/golime_product_variant_view_for_details.dart';
...
import '/theme2/views/product_details_screen/widgets/easy_subscription_view.dart';
import '/theme2/views/shimmer/product_detail_shimmer_view.dart';
import '/theme2/views/webview_pages/webview_pages_screen.dart';
import '/theme2/views/widgets/related_product_widget.dart';
                                        ...
                                        child: CustomButton(
                                          ...
                                          onPressed: () async {
                                            if (await Session().IsLogin()) {
                                              AddToCallFunction(context1, true);
                                            } else {
                                              bool? refresh =
                            ...
                            children: [
                              ...
                              state.product.productVariants!.length > 1
                                  ? Container(
                                      padding: const EdgeInsets.only(
                                          ...
                                          right: ThemeSize.paddingRight,
                                          top: 5),
                                      child: (AppConfig.APP_NAME
                                                  .toUpperCase() ==
                                              "GOLIME")
                                          ? GoLimeProductVariantDetailsView(
                              ...
                              Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      (state.product.descriptionHtml != null &&
                                      ...
                                      (AppConfig.metaFieldRequired &&
                                              ...
                                              context1
                                                      ...
                                                      .length !=
                                                  0)
                                          ? GoLimeProductSpecificationWidget(
                                              context1
                                                  .read<
                                                      ProductDetailsScreenBloc>()
                                                  .productSpecification!)
