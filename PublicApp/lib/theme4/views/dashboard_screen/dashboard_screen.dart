...
import 'package:publicapp/theme4/views/dashboard_screen/email_subscription/email_subscription_bottom_sheet.dart';
import 'package:publicapp/theme4/views/dashboard_screen/custom_page_screen.dart';
import 'package:publicapp/route/theme4.dart';
...
import '/theme4/views/cart_screen/cart_screen.dart';
import '/theme4/views/category/category_from_menu/category_screen_from_menu.dart';
import '/theme4/views/category/category_screen_from_collection.dart';
import '/theme4/views/dashboard_screen/bloc/dashboard_screen_bloc.dart';
import '/theme4/views/favorite/favorite_list_screen.dart';
import '/theme4/views/home_screen/home_screen.dart';
import '/theme4/views/pages/pages_view_screen.dart';
...
import '/theme4/views/product_list/product_list_screen.dart';
import '/theme4/views/profile_screen/contact_us/contact_us_screen.dart';
import '/theme4/views/profile_screen/notification/notification_screen.dart';
import '/theme4/views/search/boost_ai_search/boost_ai_search_screen.dart';
import '/theme4/views/search/search_screen.dart';
import '/theme4/views/webview_pages/webview_pages_screen.dart';
import '/theme4/views/widgets/no_data_view.dart';
import '/theme4/views/profile_screen/profile_screen.dart';
import '../widgets/bottom_navigation/bottom_bar_widget.dart';
import '/theme4/views/widgets/drawer/drawer_widget.dart';
