...
class ProductVariantDetailsView extends StatefulWidget {
  ...
  const ProductVariantDetailsView(this.product, this.selectedVariant,
      this.onSelectApply, this.AddToCartButton,
      {super.key});

  @override
  State<ProductVariantDetailsView> createState() =>
...
class _ProductVariantBottomSheetViewState
    extends State<ProductVariantDetailsView> {
