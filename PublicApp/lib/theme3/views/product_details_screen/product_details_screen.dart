...
import '/theme3/views/product_details_screen/widgets/easy_subscription_view.dart';
import '/theme3/views/shimmer/product_detail_shimmer_view.dart';
import '/theme3/views/webview_pages/webview_pages_screen.dart';
import '/theme3/views/widgets/related_product_widget.dart';
...
class _ProductDetailsScreenState extends State<ProductDetailsScreen> {
  ...
  AddItemInCart(BuildContext context, String selectedVal, bool isByNow,
    ...
    String? sellingPlanId = globals.plugins
        ...
        sellingPlan != null ? sellingPlan!.id.toString() : null:null;
    if (isByNow) {
  ...
  AddToCallFunction(BuildContext context1, bool isByNow) {
                ...
                (context1.read<ProductDetailsScreenBloc>().product.sellingPlanGroups!=null && globals.plugins
                    .containsKey(PluginsEnum.ITGEEKS_EASY_SUBSCRIPTION.name) || globals.plugins.containsKey(PluginsEnum.RECHARGE)) ||
