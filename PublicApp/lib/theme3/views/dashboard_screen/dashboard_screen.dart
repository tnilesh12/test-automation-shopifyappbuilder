...
import 'package:publicapp/theme3/views/dashboard_screen/email_subscription/email_subscription_bottom_sheet.dart';
import 'package:publicapp/theme3/views/dashboard_screen/custom_page_screen.dart';
import 'package:publicapp/route/theme3.dart';
...
import '/theme3/views/auth/login/login_screen.dart';
import '../blog/blog_list_screen.dart';
import '/theme3/views/cart_screen/cart_screen.dart';
import '/theme3/views/category/category_from_menu/category_screen_from_menu.dart';
import '/theme3/views/category/category_screen_from_collection.dart';
import '/theme3/views/dashboard_screen/bloc/dashboard_screen_bloc.dart';
import '/theme3/views/favorite/favorite_list_screen.dart';
import '/theme3/views/home_screen/home_screen.dart';
import '/theme3/views/pages/pages_view_screen.dart';
import '/theme3/views/product_details_screen/product_details_screen.dart';
import '/theme3/views/product_list/Sort_Bottom_ListView.dart';
import '/theme3/views/product_list/product_list_screen.dart';
import '/theme3/views/profile_screen/contact_us/contact_us_screen.dart';
import '/theme3/views/profile_screen/notification/notification_screen.dart';
import '/theme3/views/search/boost_ai_search/boost_ai_search_screen.dart';
import '/theme3/views/search/search_screen.dart';
import '/theme3/views/webview_pages/webview_pages_screen.dart';
import '/theme3/views/widgets/no_data_view.dart';
import '/theme3/views/profile_screen/profile_screen.dart';
import '../widgets/bottom_navigation/bottom_bar_widget.dart';
import '/theme3/views/widgets/drawer/drawer_widget.dart';
...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  Future<bool> updateSelectedBtmNav(BottomNavigationData bottomNavData, int selectedIndex) async {
      ...
      if (bottomNavData.action == Routes.chatScreen ||
        ...
        if (isLogin) {
          ...
          bool? refresh = await (context.pushNamed("${Routes.loginScreen}",
              pathParameters: {"goBack": true.toString()}, extra: null));
          if (refresh != null) {
            if (refresh as bool) {
              setState(() {
                selectedBottomNavData = bottomNavData;
            ...
            if (state is DashboardScreenSuccessState) {
              ...
              return Scaffold(
                ...
                floatingActionButton:
                    state.dashboardDataItems!.bottomNavigationEnable!
                        ? GestureDetector(
                            onTap: () {
                              updateSelectedBtmNav(state.dashboardDataItems!
                                      .bottomNavigationData![2], 2)
                                  .then((val) {
                                if (val) {
                                  setState(() {
                                ...
                                child: Container(
                                    ...
                                    child: IconTheme(
                                      ...
                                      child: SvgPicture.string(
                                          state
                                              .dashboardDataItems!
                                              .bottomNavigationData![2]
                                              .iconSrc!,
                                          colorFilter: ColorFilter.mode(
                                              AppTheme
                                                  .bottomNavigationSelectedTextColor!,
                                              BlendMode.srcIn)),
                                    )),
                              ),
                            ),
                ...
                bottomNavigationBar:
                    state.dashboardDataItems!.bottomNavigationEnable!
                        ? BottomBarWidget(
                            state.dashboardDataItems!, bottomBarSelectedIndex,
                            onTabChange: (bottomNavItem, selectedIndexx) {
                            print(
                                "--------------DashboardScreen tabItemmmm---------${bottomNavItem}----- ${bottomNavItem.action}");
                            updateSelectedBtmNav(bottomNavItem, selectedIndexx).then((val) {
                              if (val) {
                                setState(() {
                                  bottomBarSelectedIndex = selectedIndexx;
                                });
                              }
                            });
                          })
