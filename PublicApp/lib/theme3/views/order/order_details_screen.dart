...
import 'package:shopify_code/modelClass/src/order/line_item_order/line_item_order.dart';
...
class OrderDetailsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Filter line items to include only those with non-empty custom attributes
    final filteredLineItems = order.lineItems!.lineItemOrderList!
        .where((lineItem) => lineItem.customAttributes!.isNotEmpty)
        .toList();
    return Scaffold(
        appBar: AppBar(
          leading: IconButton(
          ...
          Container(
              ...
              child:
                ...
                child: Stack(
                  children: [
                    // ListView.builder(
                    //       itemCount: order.customAttributes!.length,
                    ...
                    //                 child: Text(
                    //                    order.customAttributes![index].key, //.GetVariant().title.toString(),
                    ...
                    //                 padding: const EdgeInsets.only(top: 5.0),
                    //                 child: Text(
                    //                    order.customAttributes![index].value, //.GetVariant().title.toString(),
                    //                     overflow: TextOverflow.ellipsis,
                    //                     maxLines: 4,
                    //                     softWrap: true,
                            ...
                            child: Column(
                              ...
                              children: [
                                 Container(
                                    ...
                                    padding: const EdgeInsets.only(top: 5.0),
                                    child: Text(
                                         "Attributes", //.GetVariant().title.toString(),
                                        overflow: TextOverflow.ellipsis,
                                        maxLines: 4,
                                        softWrap: true,

                                        style: CustomTextTheme.getTextStyle(
                                            MyTextStyle.ProductDetailTitle,
                                            context) // .withAlpha(120)
                                        // style: Theme.of(context)
                                        //     .textTheme
                                        //     .bodySmall!
                              ...
                              child: Row(
                                ...
                                children: [
                                  Container(
                                    padding: const EdgeInsets.only(top: 5.0),
                                    child: Text(
                                       order.lineItems!.lineItemOrderList![index].customAttributes![index].key.toString(), //.GetVariant().title.toString(),
                                        overflow: TextOverflow.ellipsis,
                                        textAlign: TextAlign.start,
                                        style: CustomTextTheme.getTextStyle(
                                            MyTextStyle.CartRowTitle,
                                            context) // .withAlpha(120)
                                        // style: Theme.of(context)
                                        //     .textTheme
                                        //     .bodySmall!
                                  ...
                                  Container(
                                    ...
                                    padding: const EdgeInsets.only(top: 5.0),
                                    child: Text(
                                 ":"+"    ${order.lineItems!.lineItemOrderList![index].customAttributes![index].value.toString()}", 
                                        overflow: TextOverflow.ellipsis,
                                        maxLines: 4,
                                        softWrap: true,
